<script lang="ts">
	...
	let { connected, embedded = false, onSend }: { connected: boolean; embedded?: boolean; onSend: (text: string) => void } = $props();
	let draft = $state('');
